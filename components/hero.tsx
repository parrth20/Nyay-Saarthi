      ...
      <div className="container mx-auto max-w-7xl px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`${isVisible ? "animate-slide-in-right animate-delay-200" : "opacity-0"}`}>
            <Card className="p-8 border-2 border-dashed border-green-200 hover:border-green-400 transition-all duration-300 bg-white/80 backdrop-blur-sm shadow-2xl hover:shadow-3xl transform hover:scale-105">
              <div
                className={`text-center py-16 rounded-2xl transition-all duration-300 ${
                  dragActive ? "bg-green-50 border-2 border-green-300" : "hover:bg-green-25"
                }`}
