    ...
    "use client";
     ...
     // Added Library icon
     import { Menu, Scale, User, LogOut, BarChart3, MessageSquare, Phone, Upload, Loader2, Settings, Library } from 'lucide-react';
     ...
     // Helper to get initials (keep as is)
     ...
     export function Header() {
       ...
       const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
        ...
        // Add Templates to navLinks
        const navLinks = [
          { href: '/dashboard', label: 'डैशबोर्ड', icon: BarChart3 },
          { href: '/upload', label: 'अपलोड', icon: Upload },
          { href: '/templates', label: 'टेम्पलेट्स', icon: Library }, // <-- Added Link
       ...
       // ... (keep existing useEffect for auth, isActive, handleLogoutDirect) ...
       useEffect(() => {
             ...
             <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-green-100">
               <div className="container mx-auto px-4 py-4">
                 <div className="flex items-center justify-between">
                   ...
                   {/* Desktop Navigation (Ensure Templates link is included) */}
                   <nav className="hidden md:flex items-center gap-6">
                     ...
                     <div className="flex items-center gap-2">
                       {/* ... (keep existing auth dropdown logic) ... */}
                        {loading ? (
                         ...
                         <DropdownMenu onOpenChange={(open) => console.log('Dropdown open state changed:', open)}>
                           <DropdownMenuTrigger
                             className={cn(
                                 ...
                                 "disabled:opacity-50 flex items-center gap-2 px-3 h-9 py-2"
                             )}
                   ...
                   {/* Mobile Menu (Ensure Templates link is included) */}
                       ...
                       <SheetContent side="right" className="w-[280px] flex flex-col p-0">
                         {/* ... (keep existing Sheet Header) ... */}
                          ...
                          <div className="flex-grow overflow-y-auto p-4 space-y-3">
                              {navLinks.map(link => ( // Use the updated navLinks array
                                 <Link
                                   key={link.href}
                                   href={link.href}
                                   className={cn(
